...
class _AccessScreenState extends State<AccessScreen> {
  ...
  void _openAccessList(OutletResponseModel outlet) {
    ...
    return ListView(
      ...
      children: [
        Container(
          ...
          child: Text(
            'Pilih outlet untuk mengatur hak akses pada outlet tersebut.',
            style: GoogleFonts.inter(
              fontSize: 13,
