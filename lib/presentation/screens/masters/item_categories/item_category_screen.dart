...
class _ItemCategoryScreenState extends State<ItemCategoryScreen> {
  ...
  void _openListItemCategory(OutletResponseModel outlet) {
    ...
    return ListView(
      ...
      children: [
        Container(
          ...
          child: Text(
            'Pilih outlet untuk melihat daftar kategori barang milik outlet tersebut.',
            style: GoogleFonts.inter(
              fontSize: 13,
  ...
  Widget _buildOutletCard(OutletResponseModel outlet) {
    ...
    return InkWell(
      ...
      onTap: () => _openListItemCategory(outlet),
      child: Container(
